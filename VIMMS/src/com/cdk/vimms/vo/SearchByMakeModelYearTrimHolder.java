...
import java.util.*;
@Component
public class SearchByMakeModelYearTrimHolder extends AbstractSearchHolder {
    @Override
    public void populate(Vehicle vehicle) {
        String key = vehicle.getMake().getMakeName() + vehicle.getModel().getModelName() + vehicle.getModel().getYear() + vehicle.getTrim().getTrimName();
