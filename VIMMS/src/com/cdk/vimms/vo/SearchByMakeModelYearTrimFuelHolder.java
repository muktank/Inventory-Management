...
@Component
public class SearchByMakeModelYearTrimFuelHolder extends AbstractSearchHolder{

    @Override
    public void populate(Vehicle vehicle) {
        String key = vehicle.getMake().getMakeName() + vehicle.getModel().getModelName() + vehicle.getModel().getYear() + vehicle.getTrim().getTrimName() + vehicle.getFuel().getFuelType();
